	...
	const [state, setState] = useState(initialState)
	 ...
	 useEffect(() => {
        const getCardImage = async () => {
            const url = `https://pixabay.com/api/?key=19949153-2db7b3c8211ebbbd16f59e64d&q=${city}&orientation=vertical&image_type=photo&pretty=true`;
			...
			if (links.length === 0) {
				const defaultUrl = 'https://pixabay.com/api/?key=19949153-2db7b3c8211ebbbd16f59e64d&q=forecast&orientation=vertical&image_type=photo&pretty=true'
